...
@section('content')
<form action="{{dashboard_route('dashboard.banners.update', ['banner' => $item->id])}}" method="post" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="col">
        <div class="card">
                        ...
                        <div class="card-body">
                            <div>
                                ...
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="url" name="url" placeholder="@lang("admin.url")" value="{{old('url', $item->url)}}">
                                    ...
                                    <div>
                                        ...
                                        <div class="form-floating">
                                            <textarea class="form-control" placeholder="Leave a description here" id="content_{{$locale}}" name="{{$locale}}[content]" style="height: 150px">
                                                {{ old($locale.'.excerpt',$item->{'excerpt:'.$locale }) }}
                                            </textarea>
                    ...
                    <div class="card card-form">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-floating">
                                    <input type="number" class="form-control" id="order" name="order" placeholder="@lang("admin.order")" value="{{old('order',$item->order)}}">
