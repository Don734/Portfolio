                        ...
                        <div class="card-body">
                            <div class="row row-cols-1 row-cols-md-2 g-3 mb-3">
                                <div class="col">
                                    ...
                                    <div class="form-floating">
                                        <input type="datetime-local" class="form-control" id="started_at" name="started_at" placeholder="started_at" value="{{old('started_at', getDefaultFormat($item->started_at))}}">
                                ...
                                <div class="col">
                                    ...
                                    <div class="form-floating">
                                        <input type="datetime-local" class="form-control" id="finished_at" name="finished_at" placeholder="finished_at" value="{{old('finished_at', getDefaultFormat($item->finished_at))}}">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="priority" name="priority" placeholder="priority" value="{{old('priority', $item->priority)}}">
                                ...
                                <div class="form-floating">
                                    <select class="form-select custom-select" id="visibility" name="visibility">
                                        @foreach ($visibilities as $visibility)
                                            <option value="{{$visibility->value}}" @selected(old('type', $item->visibility->value) == $visibility->value)>{{$visibility->label()}}</option>
                                        @endforeach
                                    </select>
