...
@section('content')
<form action="{{dashboard_route(config("admin.route_name_prefix").'technologies.store')}}" class="dropForm" method="post" enctype="multipart/form-data">
    @csrf
    <div class="col mt-3">
        <div class="card">
            <div class="card-body">
